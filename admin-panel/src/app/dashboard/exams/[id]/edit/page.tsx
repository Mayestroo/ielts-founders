...
import {
  ...
  toMatchingAnswerMap,
  type QuestionWithAdvancedFields,
} from "@/features/exams/examBuilderShared";
...
export default function EditExamPage() {
  ...
  const [pendingSectionType, setPendingSectionType] =
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Modal
        isOpen={Boolean(pendingSectionType)}
        onClose={() => setPendingSectionType(null)}
        title="Change Section Type?"
      >
        <div className="space-y-5">
          <p className="text-sm text-slate-600 dark:text-slate-300">
            Changing this exam section from {formData.type.toLowerCase()} to{' '}
            {pendingSectionType?.toLowerCase()} will reset all questions and
            passages. This cannot be undone from the current form state.
          </p>
